...
public class ResultActivity extends AppCompatActivity {
    ...
    private void openCameraIntent(){
        ...
        startActivityForResult(Intent.createChooser(intent,"Pick a file"),REQUEST_IMAGE);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == REQUEST_IMAGE && resultCode == RESULT_OK) {
            try {
                ...
                Crop.of(source_uri, dest_uri).asSquare().start(ResultActivity.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        // if cropping acitivty is finished, get the resulting cropped image uri and send it to 'Classify' activity
            ...
            Intent i = new Intent(ResultActivity.this, ClassifyActivity.class);
